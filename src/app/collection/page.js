...
import { FaWallet, FaSearch, FaUserAlt, FaChevronDown, FaBars, FaTimes } from "react-icons/fa";
...
export default function CollectionPage() {
  ...
  const navigateToProfile = () => {
    router.push('/profile');  // Navigate to the profile page when clicked
  };
        ...
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <FaUserAlt className="w-5 h-5 text-gray-700 cursor-pointer" onClick={navigateToProfile} />
            ...
            <button
              ...
              className="flex items-center space-x-2 px-2 py-2 bg-pink-500 text-white font-semibold rounded-lg hover:bg-pink-600 text-sm"
            >
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            <button
              onClick={handleConnectWallet}
              className="flex items-center space-x-2 px-4 py-2 bg-pink-500 text-white font-semibold rounded-lg hover:bg-pink-600 text-sm"
            >
      ...
      >
        ...
        <div className="flex flex-col h-[calc(100vh-4rem)] overflow-y-auto">
          <nav className="flex-1 p-4 space-y-2">
            ...
            <a href="#" className="block py-3 px-4 text-gray-700 hover:bg-pink-100 rounded-lg transition-colors">Marketpplace</a>
